...
export const metadata: Metadata = {
  ...
  description: "Expert video editing and motion graphics for SaaS, YouTube creators, and brands by Badar Zaman. Specializing in high-retention content and cinematic storytelling.",
  keywords: [
    "Video Editor", 
