...
export default function Portfolio() {
  ...
  const videoData: Record<Category, VideoData[]> = {
    showreel: [
      { id: 1, url: "/videos/Portfolio video.mp4", title: "Portfolio video" },
      { id: 2, url: "/videos/Saas explainer video.mp4", title: "Saas explainer video" },
      { id: 3, url: "/videos/App promo video.mp4", title: "App promo video" },
    ],
    long: [
