      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        <div className="pt-32 pb-12 md:pt-40 md:pb-20">
          ...
          <div className="flex flex-col items-center gap-12 pb-12 md:flex-row md:pb-20 md:text-left">
            ...
            <div 
              className="shrink-0" 
              // We remove AOS from the container on mobile to prevent the 'invisible' delay
              data-aos="fade-up" 
              data-aos-offset="0"
            >
              <div className="relative inline-flex">
                ...
                <div className="relative overflow-hidden rounded-2xl border border-white/10 bg-gray-900 shadow-2xl">
                  <Image
                    ...
                    // FOR MOBILE SPEED:
                    priority={true}           // Preloads the image before scripts
                    loading="eager"          // Forces immediate loading
                    fetchPriority="high"     // Tells mobile browsers this is the most important asset
                    quality={85}             // Slight reduction to keep file size small for mobile data
                  />
